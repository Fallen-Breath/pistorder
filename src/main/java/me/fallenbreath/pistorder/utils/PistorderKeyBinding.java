...
{
	public static final KeyBinding CLEAR_DISPLAY_KEY = new KeyBinding("pistorder.clear_display", InputUtil.fromName("key.keyboard.p").getKeyCode(), "key.categories.misc");
